package br.com.javaprodutivo.jirapster.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jirapster@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jirapster API";

        private String description = "jirapster API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jirapster";
